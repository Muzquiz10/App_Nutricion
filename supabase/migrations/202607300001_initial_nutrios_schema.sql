...
create policy "Allowed users can insert weight logs"
...
create policy "Allowed users can insert waist logs"
...
create policy "Allowed users can insert exercise logs"
...
create policy "Allowed users can insert meal photos"
